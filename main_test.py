...
# data_cm = pd.DataFrame(confusion_matrix(y_test, naive_bayes_pred, labels=class_label), index = class_label, columns = class_label)
...
# confusion matrix
# class_label = ['NEGATIF', 'NETRAL', 'POSITIF']
# data_cm = pd.DataFrame(confusion_matrix(y_test, random_forest_pred, labels=class_label), index = class_label, columns = class_label)
# sns.heatmap(data_cm, annot = True, fmt = "d")
...
# class_label = ['NEGATIF', 'NETRAL', 'POSITIF']
# data_cm = pd.DataFrame(confusion_matrix(y_test, log_reg_pred, labels=class_label), index = class_label, columns = class_label)
# sns.heatmap(data_cm, annot = True, fmt = "d")
...
# class_label = ['NEGATIF', 'NETRAL', 'POSITIF']
# data_cm = pd.DataFrame(confusion_matrix(y_test, knn_pred, labels=class_label), index = class_label, columns = class_label)
# sns.heatmap(data_cm, annot = True, fmt = "d")
